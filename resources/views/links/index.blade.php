   ...
   <div class="page-content">
        <div class="page-header">
            ...
            <div class="ms-auto d-flex gap-2">
                <a href="{{ actionURL('LinksController@create') }}" class="btn-primary-custom modal-show modal-xl">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item modal-show"
                                            href="{{ actionURL('LinksController@edit', $item->getIdCode()) }}">
                                    ...
                                    <li>
                                        <button type="button"
                                            ...
                                            {{ modalBoxVal(actionURL('LinksController@cancel', $item->getIdCode()), null, 'ยืนยันการยกเลิก', 'ยกเลิก') }} >
                                            <img id="eye-icon"
